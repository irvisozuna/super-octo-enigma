...
export type Actions = 'create' | 'read' | 'update' | 'delete' | 'manage' | 'suspend' | 'reactivate' | 'terminate' | 'approve' | 'reject' | 'cancel' | 'renew' | 'sign' | 'assign' | 'unassign' | 'inspect' | 'verify' | 'blacklist' | 'issue' | 'pay' | 'appeal' | 'process' | 'refund' | 'activate' | 'deactivate' | 'export' | 'import' | 'configure' | 'print' | 'schedule' | 'share' | 'view'
