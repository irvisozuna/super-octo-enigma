...
<template>
            ...
            <VRow>
              ...
              >
                <AppTextField
                  ...
                  :error-messages="errors.address_line ? [errors.address_line] : []"
                />
              </VCol>
              ...
              >
                <AppSelect
                  ...
                  :error-messages="errors.currencies ? [errors.currencies] : []"
                  :menu-props="{ maxHeight: 200 }"
                />
              </VCol>
  ...
  <ConfirmDialog
    ...
    :confirmation-question="t('confirmDeactivationQuestion')"
    :confirm-title="t('deactivated')"
    :confirm-msg="t('deactivatedMessage')"
