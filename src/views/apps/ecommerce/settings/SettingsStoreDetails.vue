<template>
  <VCard title="Profile" class="mb-6">
    <VCardText>
      <VRow>
        <VCol cols="12" md="6">
          <AppTextField label="Store name" placeholder="nubik" />
        </VCol>
        <VCol cols="12" md="6">
          <AppTextField label="Phone" placeholder="+(123) 456-7890" />
        </VCol>
        <VCol cols="12" md="6">
          <AppTextField label="Store contact email" placeholder="johndoe@email.com" />
        </VCol>
        <VCol cols="12" md="6">
  ...
  <VCard title="Billing Information" class="mb-6">
    <VCardText>
      <VRow>
        <VCol cols="12" md="6">
          <AppTextField label="Legal business name" placeholder="nubik" />
        </VCol>

        <VCol cols="12" md="6">
          <AppSelect label="Country/Region" :items="['United States', 'Canada', 'UK']" placeholder="Canada" />
        </VCol>
        ...
        <VCol cols="12" md="6">
          <AppTextField label="Apartment,suit, etc." placeholder="Empire Heights" />
        </VCol>
  ...
  <VCard class="mb-6">
    ...
    <VCardText>
      <VRow>
        ...
        <VCol cols="12" md="6">
          <AppSelect label="Unit system" :items="['Metric System', 'Imperial', 'International System']"
            placeholder="Metric System" />
        </VCol>

        <VCol cols="12" md="6">
          <AppSelect label="Default weight unit" placeholder="Kilogram" :items="['Kilogram', 'Pounds', 'Gram']" />
        </VCol>
      </VRow>
    </VCardText>
  </VCard>

  <VCard title="Store currency" subtitle="The currency your products are sold in." class="mb-6">
    <VCardText>
      <AppSelect label="Store currency" :items="['USD', 'INR', 'Euro', 'Pound']" placeholder="USD" />
    </VCardText>
  </VCard>

  <VCard title="Order id format"
