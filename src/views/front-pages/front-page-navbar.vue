    ...
    <PerfectScrollbar :options="{ wheelPropagation: false }" class="h-100">
      ...
      <div>
        <div class="d-flex flex-column gap-y-4 pa-4">
          <RouterLink v-for="(item, index) in ['Home', 'Features', 'Team', 'FAQ', 'Contact us']" :key="index"
      ...
      <VAppBar
        ...
        <div class="d-flex gap-x-4">
          ...
          <VBtn v-if="$vuetify.display.lgAndUp" prepend-icon="tabler-shopping-cart" variant="elevated" color="primary"
            href="https://1.envato.market/nubik_admin" target="_blank" rel="noopener noreferrer">
            Purchase Now
          </VBtn>

          <VBtn v-else rounded icon variant="elevated" color="primary" href="https://1.envato.market/nubik_admin"
