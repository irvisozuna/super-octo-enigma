...
const demoList = [
  // { title: 'Vertical Layout', to: 'https://demos.Donical.com/vuexy-vuejs-admin-template/demo-1/dashboards/analytics' },
  // { title: 'Horizontal Layout', to: 'https://demos.Donical.com/vuexy-vuejs-admin-template/demo-5/dashboards/analytics' },
  // { title: 'Bordered Layout', to: 'https://demos.Donical.com/vuexy-vuejs-admin-template/demo-2/dashboards/analytics' },
  // { title: 'Semi Dark Layout', to: 'https://demos.Donical.com/vuexy-vuejs-admin-template/demo-3/dashboards/analytics' },
  // { title: 'Dark Layout', to: 'https://demos.Donical.com/vuexy-vuejs-admin-template/demo-4/dashboards/analytics' },
]
</script>
      ...
      <VContainer>
        <div class="d-flex justify-space-between flex-wrap gap-y-5 align-center">
          ...
          <div class="d-flex gap-x-6">
            <template
              v-for="(item, index) in [
                { title: 'github', icon: 'tabler-brand-github-filled', href: 'https://github.com/Donical' },
                { title: 'facebook', icon: 'tabler-brand-facebook-filled', href: 'https://www.facebook.com/Donicals/' },
                { title: 'twitter', icon: 'tabler-brand-twitter-filled', href: 'https://twitter.com/Donicals' },
