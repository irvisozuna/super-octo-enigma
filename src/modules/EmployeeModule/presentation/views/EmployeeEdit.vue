        ...
        <VRow>
          ...
          >
            <VSelect
              ...
              :items="[
                { value: 'active', title: t('EmployeeModule.status.active') },
                { value: 'inactive', title: t('EmployeeModule.status.inactive') },
                { value: 'vacation', title: t('EmployeeModule.status.vacation') },
              ]"
              variant="outlined"
              required
            />
