...
export const CORE_SIZES = [
  { value: 'BQ', label: 'BQ', description: 'BQ Standard', diameterInches: 1.43 },
  { value: 'NQ', label: 'NQ', description: 'NQ Standard', diameterInches: 1.875 },
  { value: 'HQ', label: 'HQ', description: 'HQ Standard', diameterInches: 2.5 },
  { value: 'PQ', label: 'PQ', description: 'PQ Standard', diameterInches: 3.345 },
  { value: 'NQ3', label: 'NQ3', description: 'NQ Three-tube system', diameterInches: 1.77 },
  { value: 'HQ3', label: 'HQ3', description: 'HQ Three-tube system', diameterInches: 2.38 },
  { value: 'PQ3', label: 'PQ3', description: 'PQ Three-tube system', diameterInches: 3.25 },
]
