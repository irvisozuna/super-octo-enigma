<!-- Generated by DDD Module Generator on 2025-07-09 -->
...
// Organisms
import ReportHeaderOrganism from '../components/organisms/ReportHeaderOrganism.vue'
import ReportFiltersOrganism from '../components/organisms/ReportFiltersOrganism.vue'
import ReportDataTableOrganism from '../components/organisms/ReportDataTableOrganism.vue'
import ReportToolbarOrganism from '../components/organisms/ReportToolbarOrganism.vue'
...
// Use Cases
import { GetReportDataUseCase } from '../../application/useCases/GetReportDataUseCase'
import { ExportReportUseCase } from '../../application/useCases/ExportReportUseCase'
import { ShareReportUseCase } from '../../application/useCases/ShareReportUseCase'
...
const getReportDataUseCase = new GetReportDataUseCase()
const exportReportUseCase = new ExportReportUseCase()
const shareReportUseCase = new ShareReportUseCase()
...
<template>
  <div
    class="report-viewer-page"
    :class="{ 'fullscreen-mode': state.isFullscreen }"
  >
    <!-- Report Header -->
    ...
    <!-- Main Content Area -->
    <div class="report-content d-flex">
      <!-- Filters Panel -->
          ...
          >
            <template #append-inner>
              <VBtn
                ...
                size="small"
                variant="text"
                @click="$copyText(shareState.link)"
              >
