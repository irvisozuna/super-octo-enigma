...
const loadCatalogs = async () => {
  loading.value = true
  try {
    const [statuses, sectors, systems, typeContracts] = await Promise.all([
      ContractsApi.getCatalog('status'),
      ContractsApi.getCatalog('sectors'),
      ContractsApi.getCatalog('systems'),
      ContractsApi.getCatalog('type_contracts'),
    ])

    statusOptions.value = statuses
    sectorOptions.value = sectors
    systemOptions.value = systems
    typeContractOptions.value = typeContracts
  }
  catch (error) {
