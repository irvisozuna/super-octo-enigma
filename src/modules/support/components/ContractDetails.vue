  ...
  <div>
              ...
              <VCol align-self="end">
                <div>
                  <span class="text-h6 font-weight-500">
                    <VIcon icon="tabler-map-pin" class="me-2" />{{$t('address')}}:
                  </span>
                  {{ contract?.address }}
                </div>
                <div class="d-flex flex-wrap mt-2">
                  <span class="flex-1-1-100">
                    <span class="text-h6 font-weight-500">
                      <VIcon icon="tabler-map-2" class="me-2" />{{$t('community')}}:
                    </span>
                    {{ contract?.community }}
                  </span>
                  <span class="flex-1-0">
                    <span class="text-h6 font-weight-500">
                      <VIcon icon="tabler-map-2" class="me-2" />{{$t('system')}}:
                    </span>
                    {{ contract?.system }}
              ...
              <VCol align-self="end">
                <VRow>
                  <VCol class="d-flex flex-wrap ga-3">
                    <VBtn variant="outlined" @click="openShowLocationDialog">
                      <VIcon icon="tabler-map-pin" class="me" />
                    </VBtn>
                    <VBtn variant="outlined" @click="openAddWorkOrderDialog">
                      <VIcon icon="tabler-tool" class="me-2" />{{$t('workorder')}}
                    </VBtn>
                    <VBtn variant="outlined" @click="openAccountBalanceDialog">
                      <VIcon icon="tabler-printer" class="me-2" />{{$t('account_balance')}}
                    </VBtn>
                    <VBtn color="primary" @click="openAddChargeDialog">
                      <VIcon icon="tabler-plus" class="me-2" />{{$t('add_charge')}}
                    </VBtn>
                  </VCol>
                </VRow>
              </VCol>
    ...
    <VRow>
                ...
                <VRow class="d-flex justify-center align-center">
                  ...
                  >
                    <div
                      ...
                      @click="toggle"
                    >
                      <h6 class="text-base mb-0">{{ contract?.debt }}</h6>
                      <h6 class="text-base text-center font-weight-light mb-0">{{$t('balance_due')}}</h6>
                    </div>
                  </VCol>
                  <VCol
                    cols="12"
                  ...
                  >
                    <div
                      ...
                      @click="toggle"
                    >
                      <h6 class="text-base mb-0">{{ contract?.positive_balance }}</h6>
                      <h6 class="text-base text-center font-weight-light mb-0">{{$t('positive_balance')}}</h6>
                    </div>
                  </VCol>
                  <VCol
                    cols="12"
                  ...
                  >
                    <div
                      ...
                      @click="toggle"
                    >
                      <h6 class="text-base mb-0">{{ contract?.months_debt }}</h6>
                      <h6 class="text-base text-center font-weight-light mb-0">{{$t('months_due')}}</h6>
                    </div>
                  </VCol>
                </VRow>
              </VCardText>
              ...
              <VCardText>
                <div class="d-flex justify-space-between mb-1">
                  ...
                  <div class="text-disabled text-sm">
                    <VIcon color="success" icon="tabler-checkbox"></VIcon>
                  </div>
                </div>
      ...
      <VCol>
        <VCard class="pa-4">
          ...
          <VCardText>
            <VList dense>
              <VListItem>
                <VIcon icon="tabler-droplet" class="me-2" />{{$t('contract_type')}}: {{ contract?.code_type_contrat }}
              </VListItem>
              <VListItem>
                <VIcon icon="tabler-calendar" class="me-2" />{{$t('contract_date')}}: {{ contract?.date_created }}
              </VListItem>
              <VListItem>
                <VIcon icon="tabler-activity" class="me-2" />{{$t('contract_status')}}: {{ contract?.status }}
              </VListItem>
              <VListItem>
                <VIcon icon="tabler-hash" class="me-2" />{{$t('meter_number')}}: {{ contract?.measurer }}
              </VListItem>
              <VListItem>
                <VIcon icon="tabler-percentage" class="me-2" />{{$t('pensionary')}}: N/A
              </VListItem>
              <VListItem>
                <VIcon icon="tabler-clock" class="me-2" />{{$t('validity')}}:
              </VListItem>
              <VListItem>
                <VIcon icon="tabler-users" class="me-2" />{{$t('handicapped')}}: N/A
              </VListItem>
              <VListItem>
                <VIcon icon="tabler-toggle-left" class="me-2" />{{$t('validity')}}:
              </VListItem>
              <VListItem>
                <VIcon icon="tabler-bookmark" class="me-2" />{{$t('business_activity')}}: {{contract?.business_activity}}
              </VListItem>
              <VListItem>
                <VIcon icon="tabler-tag" class="me-2" />{{$t('rate')}}: {{contract?.rate_type}}
              </VListItem>
            </VList>
          </VCardText>
        </VCard>
      ...
      <VCard class="pa-4">
        ...
        <VCardTitle class="text-h6">{{$t('service_summary')}}</VCardTitle>
        <VCardText>
          <VList dense>
            <VListItem>
              <VIcon icon="tabler-star" class="me-2" />{{$t('metric')}}: {{ contract?.type_charge }}
            </VListItem>
            <VListItem>
              <VIcon icon="tabler-calendar" class="me-2" />{{$t('services')}}: {{ contract?.type_services }}
            </VListItem>
          </VList>
        </VCardText>

        <!-- Datos fiscales -->
        <VCardTitle class="text-h6 mt-4">{{$t('fiscal_data')}}</VCardTitle>
        <VCardText>
          <VList dense>
            <VListItem>
              <VIcon icon="tabler-star" class="me-2" />{{$t('business_name')}}:
            </VListItem>
            <VListItem>
              <VIcon icon="tabler-devices-2" class="me-2" />{{$t('tax_id')}}:
            </VListItem>
            <VListItem>
              <VIcon icon="tabler-activity" class="me-2" />{{$t('postal_code')}}:
            </VListItem>
            <VListItem>
              <VIcon icon="tabler-calendar" class="me-2" />{{$t('cfdi_use')}}:
              <VBtn icon variant="plain" class="ms-2">
                <VIcon icon="tabler-edit-3" />
              </VBtn>
            </VListItem>
            <VListItem>
              <VIcon icon="tabler-calendar" class="me-2" />{{$t('email')}}:
              <VBtn icon variant="plain" class="ms-2">
                <VIcon icon="tabler-edit-3" />
              </VBtn>
            </VListItem>
            <VListItem>
              <VIcon icon="tabler-calendar" class="me-2" />{{$t('phone')}}:
              <VBtn icon variant="plain" class="ms-2">
                <VIcon icon="tabler-edit-3" />
              </VBtn>
            </VListItem>
