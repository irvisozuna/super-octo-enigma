...
const executeCopy = async () => {
  ...
  try {
    ...
    await documentStore.bulkCopyDocuments(selectedDocuments.value, copyForm.value)
...
<template>
  <div class="document-bulk-copy">
    <!-- Header -->
    <div class="d-flex justify-space-between align-center mb-6">
      <div>
        <h1 class="text-h4 font-weight-bold">
          {{ t('DocumentsModule.document.bulk_copy') }}
        </h1>
        <p class="text-body-1 text-medium-emphasis mt-1">
          {{ t('DocumentsModule.document.bulk_copy_subtitle') }}
        </p>
      </div>
        ...
        <div class="d-flex justify-space-between align-center">
          ...
          <div class="d-flex gap-2">
            <VBtn
              ...
              @click="handleCopy"
            >
              {{ t('DocumentsModule.document.copy_selected') }}
            </VBtn>
    ...
    >
      <VCardTitle>
        {{ t('DocumentsModule.document.copy_form') }}
      </VCardTitle>

      <VCardText>
        <VForm @submit.prevent="executeCopy">
          <VRow>
            <VCol
              cols="12"
              md="6"
            >
              <VSelect
                v-model="copyForm.target_category"
            ...
            >
              <VTextField
                v-model="copyForm.target_folder"
            ...
            >
              <VSwitch
                v-model="copyForm.preserve_structure"
            ...
            >
              <VSwitch
                v-model="copyForm.create_folders"
            ...
            >
              <VSwitch
                v-model="copyForm.copy_metadata"
                :label="t('DocumentsModule.document.copy_metadata')"
                color="primary"
              />
            </VCol>
            ...
            >
              <VSwitch
                v-model="copyForm.copy_versions"
                :label="t('DocumentsModule.document.copy_versions')"
                color="primary"
              />
            </VCol>
          </VRow>
