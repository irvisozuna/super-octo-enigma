...
const deleteSelected = async () => {
  ...
  if (confirm(t('DocumentsModule.messages.confirm_bulk_delete', { count: selectedCount.value }))) {
    try {
      deleting.value = true
...
<template>
  <div class="document-bulk-delete">
    <!-- Header -->
    <div class="d-flex justify-space-between align-center mb-6">
      <div>
        <h1 class="text-h4 font-weight-bold">
          {{ t('DocumentsModule.document.bulk_delete') }}
        </h1>
        <p class="text-body-1 text-medium-emphasis mt-1">
          {{ t('DocumentsModule.document.bulk_delete_subtitle') }}
        </p>
      </div>
      ...
      <VCardText>
        <div class="d-flex justify-space-between align-center">
          ...
          <div class="d-flex gap-2">
            ...
            >
              {{ t('DocumentsModule.document.delete_selected') }}
            </VBtn>
