...
export const readingsReportBaseValidation = yup.object({
  first_name: yup
    .string()
...
export const treadingsReportCreateValidation = readingsReportBaseValidation.shape({
  role: yup
    .array()
    .nullable()
    .min(1, t('validations.minItems', { field: t('fields.role'), count: 1 })),
...
export const readingsReportEditValidation = readingsReportBaseValidation.shape({
