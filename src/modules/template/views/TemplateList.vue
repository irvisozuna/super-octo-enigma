...
<template>
  <VCard>
    ...
    <TemplateFilters
      :initial-filters="templateStore.filters"
    ...
    <VCardText>
      <div class="d-flex align-center flex-wrap gap-4 justify-end">
        <!-- Campo de búsqueda -->
        <VTextField
          v-model="templateStore.filters.search"
        ...
        <VBtn
          v-if="templateStore.selectedItems.length > 1"
          color="error"
    ...
    <TemplateTable
      ...
      :items-per-page="templateStore.itemsPerPage"
      :loading="templateStore.isLoading"
      :selection="templateStore.selectedItems"
      @update:selection="val => templateStore.selectedItems = val"
